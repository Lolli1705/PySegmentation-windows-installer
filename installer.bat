...
set APP_NAME=PySegmentation

:: Git Info

set GIT_HOST=https://github.com/
set GIT_NAME=Lolli1705/
set REPO_NAME=PySegmentation
...
set APP_INSTALLATION_DIR=%PYSEG_INSTALLATION_DIR%\PySegmentation-main\
set PYTHON_INSTALLER=%PYSEG_INSTALLATION_DIR%\python_installer.exe
set PYSEG_ICON=%PYSEG_INSTALLATION_DIR%\PySegmentation-main\img\icon.ico
set REQ_PATH=%PYSEG_INSTALLATION_DIR%\PySegmentation-main\requirements
set LOGO=%PYSEG_INSTALLATION_DIR%\PySegmentation-main\img\logo.ico
...
set PYSEG_LAUNCHER_LINK=%USERPROFILE%\Desktop\PySegmentation.lnk
...
(
	echo /
	echo /
	echo start  "%APP_NAME%" "%PYTHON_INSTALLATION_DIR%\pythonw.exe" "%PYSEG_INSTALLATION_DIR%\PySegmentation-main\main.py"
) >> "%LAUNCHER%"
